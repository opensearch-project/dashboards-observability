 ...
 *
 * Extracted from `server/routes/alerting/handlers.ts` during the
 * route-reduction pass. The rest of that file — datasource / list / read /
 * unified / detail handlers — now lives on the client (query services) and
 * was deleted.
 */
