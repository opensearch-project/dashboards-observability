...
---
Piped Processing Language (PPL) is a query language that processes data in a sequential, step-by-step manner. PPL uses a set of commands, connected by pipes (|), to process data and return results. Note that the requests and results are read-only. 
...
PPL is designed to be easy to use. You do not need to learn a complex syntax or fully understand how OpenSearch works.
