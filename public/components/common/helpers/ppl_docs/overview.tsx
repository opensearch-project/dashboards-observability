...
You can query data in OpenSearch using PPL, [Query DSL](https://opensearch.org/docs/latest/query-dsl/index/), or [SQL](https://opensearch.org/docs/latest/search-plugins/sql/sql/index/).
...
PPL is the primary language used with observability in OpenSearch, and it supports multi-data queries. Developers, DevOps engineers, support engineers, site reliability engineers (SREs), and IT managers find it useful for exploring and discovering log, monitoring, and observability data. For example, you can use PPL to:
...
PPL is availble in OpenSearch Dashboards and in a standalone command-line tool. Within OpenSearch Dashboards, you can use [Query Workbench](https://opensearch.org/docs/latest/dashboards/query-workbench/) to run
...
Here's an example of a PPL query. This query will retrieve the first and last names of all account where the age is greater than 18.
