...
A delimited identifier is an identifier enclosed in backticks \`\` that contain special characters not permitted in regular identifiers. This allows for the use of characters that would otherwise violate the naming rules for identifiers.
