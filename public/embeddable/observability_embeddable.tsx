...
import { PROMQL_METRIC_SUBTYPE, observabilityMetricsID } from '../../common/constants/shared';
...
> {
  ...
  public async reload() {
    ...
    const isMetric = this.attributes?.savedVisualization?.sub_type === PROMQL_METRIC_SUBTYPE;
    if (isMetric) {
